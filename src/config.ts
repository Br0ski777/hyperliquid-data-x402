...
Do NOT use for real-time order book -- use hyperliquid_get_market_data. Do NOT use for spot DEX quotes -- use dex_get_swap_quote. Do NOT use for whale tracking -- use hyperliquid_track_whale_positions.`,
    ...
    },
    {
      ...
      path: "/api/candles",
      price: "$0.002",
      description: "OHLCV candlestick data for a Hyperliquid perp pair (POST variant)",
      toolName: "hyperliquid_get_candles",
      toolDescription: `Use this when you need historical OHLCV candlestick data for a Hyperliquid perpetual pair. Returns open, high, low, close, volume for the specified interval. POST variant of hyperliquid_get_candles -- same params passed as JSON body instead of query string.
